...
namespace StoreApp.Models
{
    ...
    {
        public RepositoryContext(DbContextOptions<RepositoryContext> options):base(options)//base->DbContext
        {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>().HasData(
                ...
                new Product(){ProductId=6,ProductName="Playstation 5",Price=15000}
            );
        }
    }
}
